 // Blog Search and Filter
        ...
        function downloadResume() {
            // Create a sample PDF blob (in real implementation, this would be your actual resume)
            const pdfContent = `
                %PDF-1.4
                1 0 obj
                <<
                ...
                /F1 12 Tf
                100 700 Td
                (Sample Resume - Ali Mohammadi) Tj
                ET
                endstream
                endobj
            ...
            a.href = url;
            a.download = 'Ali-Mohammadi-Resume.pdf';
            ...
            notification.innerHTML = '<i class="fas fa-check ml-2"></i>رزومه دانلود شد';
